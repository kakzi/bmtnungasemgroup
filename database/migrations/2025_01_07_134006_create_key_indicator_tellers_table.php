...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('key_indicator_tellers', function (Blueprint $table) {
            ...
            $table->string('nilai_akhir')->storedAs('CASE WHEN `rata-rata` BETWEEN 2.72 AND 4.25 THEN "Teller A" WHEN `rata-rata` BETWEEN 1.53 AND 2.71 THEN "Teller B" WHEN `rata-rata` BETWEEN 0.8 AND 1.52 THEN "Teller C" WHEN `rata-rata` BETWEEN 0.17 AND 0.79 THEN "Teller D" ELSE "Teller E" END')->nullable();
            $table->timestamps();
        });
    }
